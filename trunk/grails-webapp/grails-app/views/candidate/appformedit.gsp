...
<html>
	...
	model="['candidateInstance':candidateInstance]" />
        <div class="body">
            ...
            <br/><br/>
            <i>Παρακαλούμε, για την επεξεργασία της αίτησής σας, συμπληρώστε εκ νέου και τα τρία πεδία</i>
            <br/><br/>
            ...
            <g:form action="appformupdate" method="post" enctype="multipart/form-data">
                <g:hiddenField name="appformid" value="${applicationFormInstance?.id}" />
                ...
                <g:hiddenField name="oldappformid" value="${oldApplicationFormInstance.id}" />
