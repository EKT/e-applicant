<div class="nav">
            ...
            <g:if test="${type == '0'}"> 
                <span title="Αιτήσεις" ><g:link controller="applicationForm"><img src="${request.getContextPath()}/images/applications_icon.png"></g:link></span>
                <span title="Υποψήφιοι" ><g:link controller="candidate" action="list"><img src="${request.getContextPath()}/images/users_icon.png"></g:link></span>
             	<span title="Συνεντεύξεις" ><g:link controller="interview" action="list"><img src="${request.getContextPath()}/images/interviews_icon.png"></g:link></span>           	
             	&nbsp&nbsp
            ...
            <g:if test="${type == '1'}"> 
                <span title="Αιτήσεις" ><g:link controller="applicationForm"><img src="${request.getContextPath()}/images/applications_selected_icon.png"></g:link></span>
            	<span title="Υποψήφιοι" ><g:link controller="candidate" action="list"><img src="${request.getContextPath()}/images/users_icon.png"></g:link></span>
            	<span title="Συνεντεύξεις" ><g:link controller="interview" action="list"><img src="${request.getContextPath()}/images/interviews_icon.png"></g:link></span>            	
            	&nbsp&nbsp
            	<g:ifAnyGranted role="ROLE_SYS_ADMIN,ROLE_ADMIN">
            ...
            <g:elseif test="${type == '5'}">
                <span title="Αιτήσεις" ><g:link controller="applicationForm"><img src="${request.getContextPath()}/images/applications_icon.png"></g:link></span>
            	<span title="Υποψήφιοι" ><g:link controller="candidate" action="list"><img src="${request.getContextPath()}/images/users_selected_icon.png"></g:link></span>
            	<span title="Συνεντεύξεις" ><g:link controller="interview" action="list"><img src="${request.getContextPath()}/images/interviews_icon.png"></g:link></span>
            	&nbsp&nbsp
            	<g:ifAnyGranted role="ROLE_SYS_ADMIN,ROLE_ADMIN">
            		<span title="Προσκλήσεις" ><g:link controller="invitation"><img src="${request.getContextPath()}/images/invitation_icon.png"></g:link></span>
            ...
            <g:elseif test="${type == '6'}">
                <span title="Αιτήσεις" ><g:link controller="applicationForm"><img src="${request.getContextPath()}/images/applications_icon.png"></g:link></span>
            	<span title="Υποψήφιοι" ><g:link controller="candidate" action="list"><img src="${request.getContextPath()}/images/users_icon.png"></g:link></span>
            	<span title="Συνεντεύξεις" ><g:link controller="interview" action="list"><img src="${request.getContextPath()}/images/interviews_selected_icon.png"></g:link></span>
            	&nbsp&nbsp
            	<g:ifAnyGranted role="ROLE_SYS_ADMIN,ROLE_ADMIN">
            		<span title="Προσκλήσεις" ><g:link controller="invitation"><img src="${request.getContextPath()}/images/invitation_icon.png"></g:link></span>
            		<span title="Έργα" ><g:link controller="project"><img src="${request.getContextPath()}/images/project_icon.png"></g:link></span>
